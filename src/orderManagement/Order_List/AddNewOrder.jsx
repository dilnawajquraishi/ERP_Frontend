...
const AddNeworder = () => {
  return (
    <div className=' px-5 ' style={{height:"100%",width:"100%"}}>
...
<select className=" h-11 w-full rounded-l-md"style={{border:"1px solid  grey",outline:"none" }}>
...
<div className='h-20  w-full    flex flex-col '>
  ...
  <input type='text' placeholder='order no' className='w-full px-2 h-11' style={{outline:"none"}} />
  </div>
 ...
 <div className='h-20  w-full    flex flex-col '>
  ...
  <input type='text' placeholder='GSM' className='w-full px-2 h-11' style={{outline:"none"}} />
  </div>
...
<select className=" h-11 w-full rounded-l-md"style={{border:"1px solid  grey" }}>
...
<div htmlFor="upload" className=" mt-2">
    <p className=' ms-2'>    Upload Item Image </p>
  <input type="file" name="im" id="upload" accept="image/*" className="d-none file-input-change" data-id="image" />
...
<p className='w-32 mb-1 text-black pt-2' style={{fontSize:"13px"}}>Enter Shipment Mode</p>
  <input type='text' placeholder='Enter Shipment Mode' className='w-full px-2 h-11' style={{outline:"none"}} />
  </div>

  <div className='h-20  w-full    flex flex-col  '>
<p className='w-32 mb-1 text-black pt-2' style={{fontSize:"13px"}}>Enter Year</p>
  <input type='text' placeholder='Enter year' className='w-full px-2 h-11' style={{outline:"none"}} />
  </div>
