...
<FaUserAlt className='pb-1' style={{fontSize:"33px"}} />
      ...
      <div className='form w-auto flex flex-row gap-4 mt-5 ms-4 '>
        ...
        <select className="select h-11 w-80 text-center" style={{ border: "1px solid  grey", outline: "none", borderRadius: "5px" }}>
        ...
        <input type='text' className='w-80 h-11 font-bold text-center' placeholder='Search...' style={{ border: "1px solid grey", borderRadius: "5px" }} />
