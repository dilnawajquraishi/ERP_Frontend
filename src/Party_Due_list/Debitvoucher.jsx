...
const Debitvoucher = () => {
  return (
    <div className='w-auto bg-white pl-4' style={{height:"100vh"}}>
...
<Link to='/debitvoucher' className='ordersummary  h-10 w-40 pl-9 pt-2 text-white bg-purple-500'>Debit List
</Link>
